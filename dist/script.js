(() => {
  ...
  var monthLeftButton = document.createElement("button");
  ...
  var monthRightButton = document.createElement("button");
  ...
  var yearsRange = [];
  var yearsRanges = [];
  var yearNavigationModeFlag = yearNavigationModes.year;
  ...
  yearButton.addEventListener("click", () => {
    ...
    yearsRange.forEach((year) => {
      yearsWrapper.appendChild(createYearDiv(year, () => {
        generateCalendar(year, months2.indexOf(monthButton.innerText));
    ...
    if (yearNavigationModeFlag === yearNavigationModes.tenYears) {
      ...
      yearsRanges.forEach((yearRange) => {
        yearsWrapper.appendChild(createYearRangeDiv(yearRange, () => {
          generateCalendar(Number(yearRange.slice(0, 4)), months2.indexOf(monthButton.innerText));
          hideMonthDays();
          clearChildElements(yearsWrapper);
          yearsRange.forEach((year) => {
            yearsWrapper.appendChild(createYearDiv(year, () => {
  ...
  monthLeftButton.addEventListener("click", () => {
    if (months2.indexOf(monthButton.innerText) - 1 < 0) {
      generateCalendar(Number(yearButton.innerText) - 1, 11);
    } else {
      generateCalendar(Number(yearButton.innerText), months2.indexOf(monthButton.innerText) - 1);
    }
  });
  monthRightButton.addEventListener("click", () => {
    if (months2.indexOf(monthButton.innerText) + 1 > 11) {
  ...
  yearLeftButton.addEventListener("click", () => {
    if (yearNavigationModeFlag === yearNavigationModes.year) {
      generateCalendar(Number(yearButton.innerText) - 1, months2.indexOf(monthButton.innerText));
    }
    if (yearNavigationModeFlag === yearNavigationModes.tenYears) {
      generateCalendar(Number(yearButton.innerText) - 10, months2.indexOf(monthButton.innerText));
      hideMonthDays();
      clearChildElements(yearsWrapper);
      yearsRange.forEach((year) => {
        yearsWrapper.appendChild(createYearDiv(year, () => {
    ...
    if (yearNavigationModeFlag === yearNavigationModes.hundredYears) {
      generateCalendar(Number(yearButton.innerText) - 100, months2.indexOf(monthButton.innerText));
      hideMonthDays();
      clearChildElements(yearsWrapper);
      yearsRanges.forEach((yearRange) => {
        yearsWrapper.appendChild(createYearRangeDiv(yearRange, () => {
  ...
  calculateButton.addEventListener("click", () => {
    ...
    const interval = Interval.fromDateTimes(birthDate, now2);
    ...
    if (birthDate.day > now2.day || birthDate.month > now2.month || birthDate.year > now2.year) {
